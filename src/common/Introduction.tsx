...
const Introduction: React.FC<{}> = () => {
  ...
  const text = <>
    <Text>
      ...
      Once collected, the data will be analyzed to look for common patterns. We are also planning to train a recommender system that will try to suggest new games to you!<br />
      <br />
      The survey should take you around 10 minutes to complete and it consists of the following questionnaires:
      <OrderedList>
      ...
      <br />
      Before you fill out any of these, you will receive a brief description to help you understand their purpose.<br />
      ...
      You will have the opportunity to look at the results of BHI and BPNS-FS.
      <br />
      <br />
